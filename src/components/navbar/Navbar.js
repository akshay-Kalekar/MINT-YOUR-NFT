...
const Navbar = () => {
  ...
  function setAddress(ethaddy){
    address = ethaddy;
    if (address != null) {setConnected(!isConnected);}
  ...
  function handleButtonClick(){
    ...
    async function mintNFT(){
      ...
      const nftdata = await nftContract.mintNFT(address,'https://gateway.pinata.cloud/ipfs/Qmd2E7dUXBhFWUGcUpTKyD3obsANkJxurcP163nX77XZyQ://');
      console.log(nftdata);
    }
